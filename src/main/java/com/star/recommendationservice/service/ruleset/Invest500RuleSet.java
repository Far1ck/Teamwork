    ...
    public Optional<Recommendation> checkRecommendationRuleSet(UUID userId) {
        ...
        && recommendationsServiceRepository.getSavingDepositSum(userId) > 1000) {
            return Optional.of(new Recommendation(
                    ...
                    "в виде вычета на взнос в следующем налоговом периоде. Не упустите возможность разнообразить " +
                    "свой портфель, снизить риски и следить за актуальными рыночными тенденциями. Откройте ИИС " +
                    "сегодня и станьте ближе к финансовой независимости!"));
        }
